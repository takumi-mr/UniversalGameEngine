<template>
  <div class="uno-view">
    ...
    <div v-if="state.status === 'FINISHED'" class="winner-banner">🎉 {{ state.message }} 🎉</div>
    ...
    <div class="play-area">
      ...
      <div class="discard-area">
        ...
        >
          <CardFace :card-value="getCardValue(topCard)" :color="state.currentColor" />
        </div>
    ...
    <div class="my-area" :class="{ 'is-my-turn': isMyTurn }">
      <div class="my-header">
        ...
        <button v-if="isMyTurn" class="pass-btn" @click="passTurn">パス (Pass)</button>
      </div>
      ...
      <div v-if="showColorPicker" class="color-picker-overlay">
        <div class="color-picker-modal">
          ...
          <div class="color-options">
            <button class="color-btn is-red" @click="playWildCard(0)" />
            <button class="color-btn is-yellow" @click="playWildCard(1)" />
            <button class="color-btn is-green" @click="playWildCard(2)" />
            <button class="color-btn is-blue" @click="playWildCard(3)" />
          </div>
      ...
      <div class="my-hand">
        ...
        >
          <CardFace :card-value="getCardValue(card)" :color="getCardColor(card)" />
        </div>
      </div>
    </div>
  </div>
...
const isPlayable = (card: number) => {
  ...
  return (
    cColor === props.state.currentColor || cValue === tValue || cColor === 4 // ワイルドカードはいつでも出せる
  );
};
