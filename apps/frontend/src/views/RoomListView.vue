        ...
        <v-row justify="center">
          <v-col cols="12" md="10" lg="8">
            ...
            <v-row v-else-if="rooms.length > 0">
              <v-col v-for="room in rooms" :key="room.id" cols="12" sm="6" md="4">
                <v-card class="room-card rounded-xl pa-4" border="none">
                  <v-card-item>
                    <template #prepend>
                      <v-icon icon="mdi-door-open" color="primary" size="32" />
                    </template>
            ...
            <v-sheet
              ...
              color="transparent"
            >
              <v-icon icon="mdi-ghost-off" size="64" color="medium-emphasis" class="mb-4" />
              ...
              <v-btn color="primary" variant="flat" @click="createNewRoom">
    ...
    <v-dialog v-model="showJoinDialog" max-width="400">
      <v-card class="rounded-xl pa-4">
        ...
        <v-card-actions class="flex-column gap-2 mt-4">
          ...
          <v-btn block variant="text" class="mt-2" @click="showJoinDialog = false">
            {{ $t("common.cancel") }}
          </v-btn>
        </v-card-actions>
      </v-card>
    ...
    <v-dialog v-model="showCustomSetup" max-width="560" persistent>
      <v-card class="rounded-xl pa-4">
        ...
        <v-card-actions class="flex-column gap-2 mt-2">
          ...
          <v-btn block variant="text" class="mt-1" @click="showCustomSetup = false"> Cancel </v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
  </v-app>
