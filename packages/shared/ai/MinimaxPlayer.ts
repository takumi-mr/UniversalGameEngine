 ...
 */
export type EvaluationFunction<TState extends BaseGameState> = (state: TState, playerId: string) => number;
 ...
 */
export class MinimaxPlayer<TState extends BaseGameState, TAction extends BaseGameAction>
