...
import type {
  GameServiceClient as _universal_game_engine_GameServiceClient,
  GameServiceDefinition as _universal_game_engine_GameServiceDefinition,
} from "./universal_game_engine/GameService";
...
export interface ProtoGrpcType {
  universal_game_engine: {
    ...
    GameService: SubtypeConstructor<
      typeof grpc.Client,
      _universal_game_engine_GameServiceClient
    > & { service: _universal_game_engine_GameServiceDefinition };
