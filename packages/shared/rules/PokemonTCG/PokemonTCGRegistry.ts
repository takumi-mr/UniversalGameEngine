import type { PokemonTCGState } from "@engine/shared/rules/PokemonTCG/PokemonTCGRuleset";
...
export const PokemonTCGRegistry: Record<string, CardDefinition> = {
  ...
  p_crobat_v: {
    ...
    attacks: [{ name: "Venomous Fang", cost: { DARK: 2, COLORLESS: 1 }, damage: 70 }],
  },
